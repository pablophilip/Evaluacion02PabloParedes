<%-- 
    ...
    Created on : 13-07-2020, 16:24:37
    Author     : pparedes
--%>
...
<html>
    ...
    <body>
        ...
        <form action="ControladorEquipo" method="post">
            ...
            <tr>
                <td>Jugadores</td>
                <td><input type="number" name="jugador" readonly="true" value="<%= eq.getJugador() %>"/></td>           
            </tr>
            <tr>
                <td>Ciudad</td>
            ...
            <tr>
                ...
                <td><select name="divicion">
                            ...
                            <option value="<%= d.getCodigo()%>"
                                    <%if(d.getCodigo()== eq.getCiudad().getCodigo()){ out.print("selected='selected'");}%>
                                  ><%= d %></option>
